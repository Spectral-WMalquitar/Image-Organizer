...
--
-- Dumping data for table `tblalbums`
--

LOCK TABLES `tblalbums` WRITE;
/*!40000 ALTER TABLE `tblalbums` DISABLE KEYS */;
INSERT INTO `tblalbums` VALUES (1,'Mga VIrus'),(2,'Mga Pogi'),(3,'pogi'),(4,'mio'),(5,'nganga');
/*!40000 ALTER TABLE `tblalbums` ENABLE KEYS */;
UNLOCK TABLES;
